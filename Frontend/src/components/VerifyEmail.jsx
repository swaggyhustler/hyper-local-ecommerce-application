...
const VerifyEmail = ()=>{
    ...
    return (
        <div className="h-screen w-full flex justify-center items-center ">
            <form className="max-w-lg mx-auto shadow-lg p-6 rounded-lg flex justify-center items-center flex-col" onSubmit={handleSubmit}>
                <h1 className="text-3xl font-bold text-center inline-block w-96">Hyper Local E-Commerce Application</h1>
                <h3 className="text-center text-2xl text-center font-bold my-4 text-blue-300">You will receive a code to your email shortly</h3>
