...
const orderHandler=()=>{
    if (cartItems.length==0){
        toast.error("Please Add Items to cart to Order")
        return 
    }
  ...
  return (
    <div className="w-full p-5 flex flex-col items-center justify-center gap-6">
      ...
      <div className="w-full max-w-4xl flex flex-col sm:flex-row justify-between items-center bg-white shadow-md p-5 rounded-lg">
        ...
        <button onClick={orderHandler} className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 hover:from-pink-600 hover:to-orange-500 hover:text-white transition-all">
